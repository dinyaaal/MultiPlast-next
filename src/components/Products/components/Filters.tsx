...
export const Filters: React.FC<FiltersProps> = ({
  ...
  return (
    <div className="trade__filters filters-trade">
      <ButtonMain type="button" onPress={toggleMenu} className="w-full! xl:hidden" color='transparent' variant='bordered'>
        <svg
          width="18"
          height="17"
          viewBox="0 0 18 17"
      ...
      <div
        className={` filters-trade__body body-filters-trade ${isOpen ? "active" : ""
          }`}
      >
        <div className="body-filters-trade__wrapper ">
          <div className="flex flex-col gap-3 xl:hidden w-full">

            <ButtonMain onPress={closeMenu} color='transparent' className={'w-fit'}>
              <MoveLeft />
              {t("back")}
            </ButtonMain>
            <ButtonMain type="button" onPress={closeMenu} className="w-full!" color='transparent' variant='bordered'>
              <svg
                width="18"
                height="17"
                viewBox="0 0 18 17"
