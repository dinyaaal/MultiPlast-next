    ...
    <>
      <div className="body-chat__content">
        ...
        {uploadedFiles.length > 0 && (
          <div className="body-chat__uploaded-files uploaded-files">
            <div className="uploaded-files__title">Загруженные файлы:</div>
            <div className="uploaded-files__list">
              {uploadedFiles.map((uploadedFile) => (
                <div key={uploadedFile.id} className="uploaded-files__item">
                  {uploadedFile.preview ? (
                    <div className="uploaded-files__preview">
                      <Image
                  ...
                  <div className="uploaded-files__info">
                    <div className="uploaded-files__name">{uploadedFile.file.name}</div>
                    <div className="uploaded-files__size">
