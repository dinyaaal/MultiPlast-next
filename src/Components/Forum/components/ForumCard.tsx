    ...
    <div className="body-forum__item item-forum">
      ...
      <div className="item-forum__body">
        <div className="item-forum__block">
          ...
          <p className="item-forum__text">
            Ключовими властивостями полікарбонату є висока прозорість, відносно
            мала вага та дуже висока ударна в'язкість (удароміцність).
            Полікарбонат є полімерним пластиковим матеріалом, який можна
            використовувати по-різному. Завдяки фізичним властивостям
            полікарбонату цей матеріал широко використовується у будівництві та
            архітектурі. Ми можемо використовувати ...{" "}
          </p>
        </div>
        <div className="item-forum__block">
