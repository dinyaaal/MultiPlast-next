                ...
                <div className="block-chat__items">
                  <div className="block-chat__section">
                    ...
                    <div className="block-chat__section-items">
                      <div className="block-chat__item item-block-chat">
                        <div className="item-block-chat__topic topic-message">
                          <div className="topic-message__block">
                            <p className="topic-message__title">
                              ...
                              adipisicing elit. Quibusdam dolorum libero odit
                              sed fugit consequatur obcaecati vero repellat eius
                              fuga.
                            </p>
                            <div className="topic-message__user">
                              <p>
                                Контактна особа:{" "}
                                <span>Дмитро Вишнивецький</span>
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="item-block-chat__body">
                            <div className="item-block-chat__info">
                              <div className="item-block-chat__block">
                                ...
                                <span className="item-block-chat__date">
                                  23.01.24
                                </span>
                              </div>
                                ...
                                <div className="actions-menu__body body-actions-menu">
                                  <ul className="body-actions-menu__list">
                                    <li className="body-actions-menu__item">
                                      <a
                                        href="#"
                                        className="body-actions-menu__button"
                                      >
                                        Поскаржитися
                                      </a>
                                    </li>
              ...
              <div className="body-chat__content">
                <div className="body-chat__top chat-top">
                  <div className="chat-top__block">
                    <a href="#" className="chat-top__back">
                      <svg
                        width="7"
                        height="12"
                        viewBox="0 0 7 12"
                        ...
                        <div className="body-chat__message-body message-body message-body--right">
                          <div className="message-body__content">
                            <p>
                              ...
                              використовувати для будівництва, достатньо міцний
                              та прозорий. Кольори є різні, але прозорий в
                              наявності є, хочете зробити замовлення?
                            </p>
